...
{
	class ClearDukesTask : ClearHistoryShared
	{
		public ClearDukesTask( Options options, Logger log ) : base( options, log )
		{
		...
		protected override bool Execute()
		{
			...
			ClearHistoryCreateFiles( m_options.Data.Duchies );
