...
{
	class ClearKingsTask : ClearHistoryShared
	{
		public ClearKingsTask( Options options, Logger log ) : base( options, log )
		{
		...
		protected override bool Execute()
		{
			...
			ClearHistoryCreateFiles( m_options.Data.Kingdoms );
